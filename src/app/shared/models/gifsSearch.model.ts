...
export class Convert {
    public static toGIFSearch(json: string): GIFSearch {
        return cast(JSON.parse(json), r("GIFSearch"));
    }

    public static gIFSearchToJson(value: GIFSearch): string {
        return JSON.stringify(uncast(value, r("GIFSearch")), null, 2);
    }
}
